...
<body class="bg-primary" style="background: url(HR.jpg) no-repeat fixed right;">
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-5">
                                 <div></div>
                                <div class="card shadow-lg border-1 rounded-lg mt-5" style="opacity: 0.9;">
                                    ...
                                    <?= form_open('');?>
                                            <div class="form-group">
                                                <label class="small mb-1" for="username" style="font-size: 14px;"></label>
                                            ...
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword" style="font-size: 14px;"></label>
                                                <input class="form-control py-4" name="password" type="password" placeholder="Enter password" autocomplete="off" />
                                            </div>
