                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse show in" id="collapsesLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">

                                    <a class="nav-link active" href="<?php echo site_url('stAccounting'); ?>" style="font-size: 14px;"><i class="fas fa-clipboard-check" style="margin-right:5px;"></i>Accounting</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <ul class="breadcrumb">
                        <li><a href="<?php echo site_url('stAccounting')?>">Accounting Forms</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <?= form_open_multipart(empty($forms_id->id) ? "stAcctADD":"stAcctADD/".$forms_id->id) ?>
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="formsname"><strong>Name:<span style="color: red;">*</span></strong></label>
                                    <input type="text" class="form-control" name="formsname" id="formsname" autocomplete="off" value="<?= (!empty($forms_id->acct_forms)) ? $forms_id->acct_forms:''; ?>" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="formstat"><strong>Status:<span style="color: red;">*</span></strong></label>
                                        <select name="formstat" id="formstat" class="form-control"required>
                                        <option value="">Select Status</option>
                                        <?php if(!empty($forms_id->forms_stats)){?>
                                        <option value="1" <?php echo ($forms_id->forms_stats == 1) ? "selected":""; ?>>Activated</option>
                                        <option value="2" <?php echo ($forms_id->forms_stats == 2) ? "selected":""; ?>>Deactivated </option>
                                        <?php }else{ ?>
