                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show in" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                 <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="<?php echo site_url('departments'); ?>" style="font-size: 14px;"><i class="fas fa-building" style="margin-right:5px;"></i>Departments/Stores</a>
                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="deptname" id="deptname" autocomplete="off" value="<?= (!empty($dept->deptname)) ? $dept->deptname:''; ?>"required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="deptstatus"><strong>Department Status:<span style="color: red;">*</span></strong></label>
                                        <select name="deptstatus" id="deptstatus" class="form-control" required>
