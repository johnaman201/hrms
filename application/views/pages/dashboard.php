                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Employees no. <?php echo $employees->empno?></div>
                                    
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Deparment/Stores no. <?php echo $departments->deptno?></div>
                                    
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Positions no. <?php echo $positions->postno?></div>
                                    
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Users no. <?php echo $users->userno?></div>
...
$(document).ready(function(){
      var calendar = $('#calendar').fullCalendar({
        ...
        eventDrop: function (event, delta) {
                    ...
                    $.ajax({
                        url: '<?php echo site_url('editevent');?>',
    ...
    function displayMessage(message) {
	    $(".response").html("<div class='success form-control'>"+message+"</div>");
    setInterval(function() { $(".success").fadeOut(); }, 5000);
}
$('#help').on("click",function(){
    alert("Just call my name and I'll be there");
});
</script>