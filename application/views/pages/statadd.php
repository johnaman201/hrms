                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="statname" id="statname" autocomplete="off" value="<?= (!empty($stat->statusname)) ? $stat->statusname:''; ?>" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="statstatus"><strong>Status:<span style="color: red;">*</span></strong></label>
                                        <select name="statstatus" id="statstatus" class="form-control"required>
