<script src="https://code.jquery.com/jquery-3.5.1.min.js" crossorigin="anonymous"></script>
       ...
       <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
        ...
        <script src="<?=base_url()?>assets/admin/fullcalendar/lib/jquery.min.js" crossorigin="anonymous"></script>        
...
<?php
if($this->session->flashdata('event_calendar') != ''){
echo '<script>toastr.warning("'.$this->session->flashdata('event_calendar').'","Check Calendar Event!");</script>';
}
...
if($this->session->flashdata('user_add_error') != ''){
        echo '<script>toastr.error("'.$this->session->flashdata('user_add_error').'","Error"); $("#emodal").modal("show");</script>';
}
