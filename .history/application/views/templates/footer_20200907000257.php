...
if($this->session->flashdata('post_val_error') != ''){
        echo "<script>toastr.error('".$this->session->flashdata('post_val_error')."','Validation  Errors Check Fields'); $('#emodal').modal('show');</script>";
}
            
if($this->session->flashdata('post_add_success') != ''){
        echo '<script>toastr.success("'.$this->session->flashdata('post_add_success').'","Success");</script>';
}
if($this->session->flashdata('post_update_success') != ''){
        echo '<script>toastr.success("'.$this->session->flashdata('post_update_success').'","Success");</script>';
}
if($this->session->flashdata('post_update_error') != ''){
        echo '<script>toastr.error("'.$this->session->flashdata('post_update_error').'","Error"); $("#emodal").modal("show");</script>';
}
