                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="row">
								...
								<div class="picture">
									<img src="<?php echo (!empty($emp->emppic)) ? base_url().'assets/admin/images/emppics/'.$emp->emppic:base_url().'assets/admin/images/emppics/' ;  ?>" class="picture-src" id="wizardPicturePreview" title="">
