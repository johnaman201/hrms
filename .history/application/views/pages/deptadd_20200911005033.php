                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <?= form_open_multipart(empty($dept->id) ? "deptadd":"deptadd/".$dept->id) ?>
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="deptname"><strong>Department Name:<span style="color: red;">*</span></strong></label>
                                    <input type="text" class="form-control" name="deptname" id="deptname" autocomplete="off" value="<?= (!empty($dept->deptname)) ? $dept->deptname:''; ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="deptstatus"><strong>Department Status:<span style="color: red;">*</span></strong></label>
                                        <select name="deptstatus" id="deptstatus" class="form-control">
                                        <option value="">Select Status</option>
                                        <?php if(!empty($dept->deptstatus)){?>
                                        <option value="1" <?php echo ($dept->deptstatus == 1) ? "selected":""; ?>>Activated</option>
                                        <option value="2" <?php echo ($dept->deptstatus == 2) ? "selected":""; ?>>Deactivated </option>
                                        <?php }else{ ?>
