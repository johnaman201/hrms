						  ...
						  <div class="picture-container">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="eadd">Emergency Contact Address:</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="empid">Emplyee ID Number:</label>
                                    ...
                                    <div class="form-group">
                                    <label for="designation">Department/Store:</label>
                                    ...
                                    <div class="form-group">
                                    <label for="empdate">Start Date of Employment:</label>
                                    ...
                                    <div class="form-group">
                                    <label for="lempdate">Last Date of Employment:</label>
