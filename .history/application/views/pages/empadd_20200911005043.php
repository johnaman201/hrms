<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo (!empty($this->session->emppic)) ? "<img src='".$this->session->emppic."' width='500' height='600'>":"<i class='fas fa-user fa-fw'></i>" ;?></a>
                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" name="contact" id="contact" row="5"><?= (!empty($emp->contact)) ? $emp->contact:''; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label for="address"><strong>Address:<span style="color: red;">*</span></strong></label>
                                    <textarea class="form-control" name="address" id="address" row="5"><?= (!empty($emp->address)) ? $emp->address:''; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mother" id="mother" value="<?= (!empty($emp->eadd)) ? $emp->mother:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="father"><strong>Father's Name:</strong></label>
                                    <input type="text" class="form-control" name="father" id="father" value="<?= (!empty($emp->eadd)) ? $emp->father:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="siblings"><strong>No. of Siblings:</strong></label>
                                    <input type="number" class="form-control" name="father" id="father" value="<?= (!empty($emp->eadd)) ? $emp->siblings:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="spouse"><strong>Spouse Name:</strong></label>
                                    <input type="text" class="form-control" name="spouse" id="spouse" value="<?= (!empty($emp->eadd)) ? $emp->spouse:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="kids"><strong>No. of Childrens:</strong></label>
                                    <input type="number" class="form-control" name="kids" id="kids" value="<?= (!empty($emp->eadd)) ? $emp->kids:''; ?>">
                                    </div>
