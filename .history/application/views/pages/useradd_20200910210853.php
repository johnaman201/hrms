                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="username"><strong>Position Name:<span style="color: red;">*</span></strong></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="userstatus"><strong>Position Status:<span style="color: red;">*</span></strong></label>
                                        <select name="userstatus" id="userstatus" class="form-control">
                                        <option value="">Select Status</option>
                                        <?php if(!empty($user->positionstatus)){?>
                                        <option value="1" <?php echo ($user->positionstatus == 1) ? "selected":""; ?>>Activated</option>
                                        <option value="2" <?php echo ($user->positionstatus == 2) ? "selected":""; ?>>Deactivated </option>
                                        <?php }else{ ?>
