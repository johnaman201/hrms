							...
							<div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="deptstatus"><strong>Department Status:<span style="color: red;">*</span></strong></label>
                                        ...
                                        <option value="1" <?php if(!empty($dept->deptstatus)) {echo ($dept->deptstatus == "1") ? "selected":"" ; }?>>Activated</option>
                                        <option value="0" <?php if(!empty($dept->deptstatus)) {echo ($dept->deptstatus == "0") ? "selected":"" ; }?>>Deactivated <?php echo $dept->deptstatus?></option>
