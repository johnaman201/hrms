                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="lname" id="lname" autocomplete="off" value="<?= (!empty($emp->lname)) ? $emp->lname:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="bday" id="bday" autocomplete="off" value="<?= (!empty($emp->bday)) ? $emp->bday:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="age"><strong>Age:<span style="color: red;">*</span></strong></label>
                                    <input type="number" class="form-control" name="age" id="age" autocomplete="off" value="<?= (!empty($emp->age)) ? $emp->age:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="contact"><strong>Contact Numbers:<span style="color: red;">*</span></strong></label>
                                    <textarea class="form-control" name="contact" id="contact" autocomplete="off" row="5"><?= (!empty($emp->contact)) ? $emp->contact:''; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label for="address"><strong>Address:<span style="color: red;">*</span></strong></label>
                                    <textarea class="form-control" name="address" id="address" autocomplete="off" row="5"><?= (!empty($emp->address)) ? $emp->address:''; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    <label for="ename"><strong>Emergency Contact Name:</strong></label>
                                    <input type="text" class="form-control" name="ename" id="ename" autocomplete="off" value="<?= (!empty($emp->ename)) ? $emp->ename:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="econtact"><strong>Emergency Contact Number:</strong></label>
                                    <input type="text" class="form-control" name="econtact" id="econtact" autocomplete="off" value="<?= (!empty($emp->econtact)) ? $emp->econtact:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="eadd"><strong>Emergency Contact Address:</strong></label>
                                    <input type="text" class="form-control" name="eadd" id="eadd" autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->eadd:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="mother"><strong>Mother's Name:</strong></label>
                                    <input type="text" class="form-control" name="mother" id="mother" autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->mother:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="father"><strong>Father's Name:</strong></label>
                                    <input type="text" class="form-control" name="father" id="father" autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->father:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="siblings"><strong>No. of Siblings:</strong></label>
                                    <input type="number" class="form-control" name="father" id="father" autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->siblings:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="spouse"><strong>Spouse Name:</strong></label>
                                    <input type="text" class="form-control" name="spouse" id="spouse"  autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->spouse:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="kids"><strong>No. of Childrens:</strong></label>
                                    <input type="number" class="form-control" name="kids" id="kids" autocomplete="off" value="<?= (!empty($emp->eadd)) ? $emp->kids:''; ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="empno" id="empno" autocomplete="off" value="<?= (!empty($emp->empno)) ? $emp->empno:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="empdate" id="empdate" autocomplete="off" value="<?= (!empty($emp->empdate)) ? $emp->empdate:''; ?>">
                                    </div>
                                    <!--<div class="form-group">
                                    ...
                                    <label for="status"><strong>Employment Status:<span style="color: red;">*</span></strong></label>
                                        ...
                                        <?php if(!empty($emp->status)){?>
                                            <?php foreach($status as $row){?>
                                                <option value="<?php echo $row->id; ?>" <?php echo ($emp->status == $row->id) ? "selected":"" ;?>><?php echo $row->statusname; ?></option>
                                            <?php } ?>
