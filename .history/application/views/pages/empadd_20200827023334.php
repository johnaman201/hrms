							...
							<div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="designation"><strong>Department/Store:<span style="color: red;">*</span></strong></label>
                                        ...
                                        <option value="<?php echo $row->id; ?>" <?php echo ($emp->designation == $row->id) ? "selected":"" ; ?>><?php echo $row->deptname; ?></option>
                                        <?php }?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    <label for="position"><strong>Position:<span style="color: red;">*</span></strong></label>
                                        ...
                                        <option value="<?php echo $row->id; ?>" <?php echo ($emp->position == $row->id) ? "selected":"" ; ?>><?php echo $row->positionname; ?></option>
                                        <?php }?>
                                        </select>
                                    </div>                                    
                                    <div class="form-group">
                                    <label for="empdate"><strong>Start Date of Employment:<span style="color: red;">*</span></strong></label>
                                    <input type="date" class="form-control" name="empdate" id="empdate" value="<?= $emp->empdate; ?>>
                                    </div>
                                    <div class="form-group">
                                    <label for="salary"><strong>Salary:<span style="color: red;">*</span></strong></label>
                                    <input type="text" class="form-control" name="salary" id="salary" value="<?= $emp->salary; ?>>
                                    </div>
                                    <div class="form-group">
                                    <label for="status"><strong>Employment Status:<span style="color: red;">*</span></strong></label>
                                        <select name="status" id="status" class="form-control">
                                        <option value="hidden">Select Status</option>
                                        <option value="Probitionary" <?php echo ($emp->status == "Probitionary") ? "selected":"" ;?>>Probitionary</option>
                                    ...
                                    <input type="date" class="form-control" name="lempdate" id="lempdate" value="<?= $emp->lempdate; ?>>
                                    </div>
                                    <div class="form-group">
                                    <label for="sss"><strong>SSS Number:</strong></label>
                                    <input type="text" class="form-control" name="sss" id="sss" value="<?= $emp->sss; ?>>
                                    </div>
                                    <div class="form-group">
                                    <label for="tin"><strong>Tin Number:</strong></label>
                                    <input type="text" class="form-control" name="tin" id="tin" value="<?= $emp->tin; ?>>
                                    </div>
                                    <div class="form-group">
                                    <label for="philhealth"><strong>PhilHealth:</strong></label>
                                    <input type="text" class="form-control" name="philhealth" id="philhealth" value="<?= $emp->philhealth; ?>">
                                    </div>
                                </div>
                            </div>
