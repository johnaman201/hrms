                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show in" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="<?php echo site_url('status'); ?>">Employment Status</a>                                    
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <ul class="breadcrumb">
                        <li><a href="<?php echo site_url('status')?>">Employment Status</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <?= form_open_multipart(empty($stat->id) ? "statadd":"statadd/".$stat->id) ?>
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <label for="statname"><strong>Name:<span style="color: red;">*</span></strong></label>
                                    <input type="text" class="form-control" name="statname" id="statname" autocomplete="off" value="<?= (!empty($stat->statusname)) ? $stat->statusname:''; ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <label for="statstatus"><strong>Status:<span style="color: red;">*</span></strong></label>
                                        <select name="statstatus" id="statstatus" class="form-control">
                                        <option value="">Select Status</option>
                                        <?php if(!empty($stat->statusstatus)){?>
                                        <option value="1" <?php echo ($stat->statusstatus == 1) ? "selected":""; ?>>Activated</option>
                                        <option value="2" <?php echo ($stat->statusstatus == 2) ? "selected":""; ?>>Deactivated </option>
                                        <?php }else{ ?>
