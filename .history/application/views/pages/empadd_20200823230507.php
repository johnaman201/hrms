                    ...
                    <div class="container-fluid">
                        ...
                        <div class="reservation-grids" style="margin-top: 15px;">
            				...
            				<div class="reservation-grid-right">
                                <div class="keywords">
           							<?php
									$data	= array('name'=>'address','placeholder'=>lang('address'), 'value'=>set_value('address', ''));
									echo form_input($data); ?>
            					</div>
            				</div>
            				<div class="clearfix"> </div>
                        ...
                        <div class="reservation-grids">
            				...
            				<div class="reservation-grid-right">
                                <div class="keywords">
           							<?php
									$data	= array('name'=>'id_no','placeholder'=>lang('id_no'), 'value'=>set_value('id_no', ''));
									echo form_input($data); ?>
            					</div>
            				</div>
            				<div class="clearfix"> </div>
                        ...
                        <div class="reservation-grids">
            					...
            					<div class="keywords">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
        									   ...
        									   <a href="<?php //echo base_url('assets/admin/uploads/ids/')?>" class="btn btn-default" download><?php echo lang('download')?></a>
            				...
            				<div class="reservation-grid-right">
                                <div class="keywords">
           							<?php
									$data	= array('name'=>'remark','placeholder'=>lang('remark'), 'value'=>set_value('remark', ''));
									echo form_input($data); ?>
            					</div>
            				</div>
            				<div class="clearfix"> </div>
