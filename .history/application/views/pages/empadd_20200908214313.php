                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="textarea" class="form-control" name="contact" id="contact" value="<?= (!empty($emp->contact)) ? $emp->contact:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="address"><strong>Address:<span style="color: red;">*</span></strong></label>
                                    <input type="textarea" class="form-control" name="address" id="address" value="<?= (!empty($emp->address)) ? $emp->address:''; ?>">
                                    </div>
                                    <div class="form-group">
