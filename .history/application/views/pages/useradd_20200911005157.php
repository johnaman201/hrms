                        ...
                        <div class="card mb-4">
							...
							<div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="username" id="username" autocomplete="off" value="<?= (!empty($user->username)) ? $user->username:''; ?>">
                                    </div>

                                    <div class="form-group">
                                    <label for="password"><strong>Password:<span style="color: red;">*</span></strong></label>
                                    <input type="password" class="form-control" name="password" id="password" autocomplete="off" value="<?= (!empty($user->pword)) ? $user->pword:''; ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="confirm_password"><strong>Confirm Password:<span style="color: red;">*</span></strong></label>
                                    <input type="password" class="form-control" name="confirm_password" id="confirm_password" autocomplete="off" value="<?= (!empty($user->pword)) ? $user->pword:''; ?>">
                                    </div>
